...
/**
 * Flowtype definitions for idb
 * Generated by Flowgen from a Typescript Definition
 * Flowgen v1.2.0
 * SEE: http://github.com/joarwilk/flowgen
 */
 ...
 */
declare export interface IDBStatic {
    ...
    open(
            name: string,
            version?: number,
            upgradeCallback?: (db: UpgradeDB) => void): Promise<DB>,
 ...
 */
declare export interface UpgradeDB {
 ...
 */
declare export interface HasCursor {
    ...
    openCursor(
            ...
            direction?: next | nextunique | prev | prevunique): Promise<Cursor>,
 ...
 */
declare export type ObjectStore = {
    ...
    createIndex(
        name: string,
        keyPath: string | string[],
        optionalParameters?: IDBIndexParameters): Index,
